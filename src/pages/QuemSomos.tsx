...
const QuemSomos = () => {
  const diferenciais = [
    ...
    },
    {
      ...
      description:
        "Entrega e retirada programada conforme sua necessidade, com frota própria em toda região metropolitana.",
    },
    {
      icon: Wrench,
        ...
        <section className="py-16 md:py-24 bg-secondary">
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto text-center">
              <h1 className="font-heading text-4xl md:text-5xl font-bold text-foreground mb-6">Quem Somos</h1>
              <p className="text-lg md:text-xl text-muted-foreground leading-relaxed">
                Especialistas em locação de equipamentos profissionais para obra, indústria e manutenção técnica desde
                2010.
              </p>
            </div>
          </div>
              ...
              <div className="grid md:grid-cols-2 gap-12 items-center bg-primary">
                <div>
                  ...
                  <div className="space-y-4 text-white/90 leading-relaxed">
                    <p>
                      Fundada em 2010, a <strong>Locamulti</strong> nasceu da necessidade do mercado por um fornecedor
                      confiável de equipamentos industriais e para construção civil.
                    </p>
                    <p>
                      Com mais de uma década de experiência, construímos nossa reputação através da qualidade dos
                      equipamentos, pontualidade nas entregas e atendimento técnico especializado.
                    </p>
                    <p>
                      Hoje, atendemos construtoras, indústrias, órgãos públicos e profissionais autônomos em toda região
                      metropolitana, com uma frota moderna e constantemente renovada.
                    </p>
                  </div>
                </div>
                <div className="relative h-80 rounded-card overflow-hidden bg-lm-ink/20">
                  <img
                    ...
                    src="/lovable-uploads/60169cc1-e31d-464b-9789-fb9ebd1f389b.webp"
                    className="w-full h-full object-cover opacity-80 border-primary-foreground"
                  />
                </div>
              </div>
            </div>
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-5xl mx-auto">
              ...
              <p className="text-lg text-muted-foreground text-center mb-12 max-w-3xl mx-auto">
                Oferecemos soluções completas em locação de equipamentos profissionais para diversos segmentos do
                mercado.
              </p>
              ...
              <div className="grid md:grid-cols-3 gap-8">
                <div className="text-center">
                  ...
                  <h3 className="font-heading text-xl font-bold text-foreground mb-3">Locação de Equipamentos</h3>
                  <p className="text-muted-foreground">
                    Mais de 500 equipamentos disponíveis para construção, soldagem, energia, movimentação e acabamento.
                  </p>
                </div>
                ...
                <div className="text-center">
                  ...
                  <h3 className="font-heading text-xl font-bold text-foreground mb-3">Manutenção Preventiva</h3>
                  <p className="text-muted-foreground">
                    Toda frota passa por revisão técnica completa e testes de segurança antes de cada locação.
                  </p>
                </div>
                ...
                <div className="text-center">
                  ...
                  <h3 className="font-heading text-xl font-bold text-foreground mb-3">Entrega e Logística</h3>
                  <p className="text-muted-foreground">
                    Entrega programada na sua obra ou empresa com frota própria e profissionais capacitados.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="max-w-6xl mx-auto">
              ...
              <div className="grid md:grid-cols-3 gap-8">
                {depoimentos.map((depoimento, index) => (
                  <div key={index} className="bg-white/10 backdrop-blur-sm p-6 rounded-card border border-white/20">
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <p className="text-lg text-white/90 mb-8 max-w-2xl mx-auto">
                Entre em contato agora e descubra como podemos ajudar seu projeto com equipamentos de qualidade e
