...
import { Hammer, Zap, Wrench, Package, PaintBucket, Cog, Trees, Shield, Clock, Headphones, Truck, CheckCircle2, MessageCircle, Building2, HardHat, Factory, TruckIcon, Warehouse, Users, Sparkles } from "lucide-react";
const Index = () => {
  const categories = [{
    id: "construcao",
