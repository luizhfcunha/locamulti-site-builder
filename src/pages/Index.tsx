  ...
  return <div className="min-h-screen flex flex-col">
    ...
    <main className="flex-1">
      ...
      <section className="relative min-h-[500px] md:min-h-[600px] lg:min-h-[700px] flex items-center">
        <div className="absolute inset-0 bg-cover bg-[position:70%_center] md:bg-center" style={{
      ...
      <section id="categorias" className="py-20 bg-secondary">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="mb-4">A mais completa linha de Equipamentos e Ferramentas para Construção Civil e Montagens Industriais Eletromecânicas de nossa Região!</h2>
          ...
          <div className="text-center mb-10">
            ...
            <div className="max-w-3xl mx-auto space-y-3">
              <p className="text-muted-foreground">
                Trabalhamos com marcas líderes e reconhecidas no mercado, garantindo equipamentos confiáveis, seguros e de alto desempenho.
              </p>
              <p className="text-muted-foreground">
                A escolha dos nossos parceiros reflete nosso compromisso com qualidade, eficiência e melhores resultados para cada cliente.
              </p>
